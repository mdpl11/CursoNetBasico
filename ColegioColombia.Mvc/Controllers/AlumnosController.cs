...
namespace ColegioColombia.Mvc.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Apellido,Cedula,Grado,Grupo")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Apellido,Cedula,Grado,Grupo")] Alumno alumno)
        {
            if (ModelState.IsValid)
            {
